...
paths = ['bfp16/size_4096/shape_1x4096', 'bfp16/size_4096/shape_64x64', 'bfp16/size_4096/shape_4096x1', 'bfp16/size_1024/shape_1x1024', 'bfp16/size_1024/shape_32x32', 
'bfp16/size_256/shape_1x256', 'bfp16/size_256/shape_16x16','bfp16/size_64/shape_1x64', 'bfp16/size_64/shape_8x8','bfp16/size_16/shape_1x16','bfp16/size_16/shape_4x4']
titles = ['1x4096','64x64','4096x1','1x1024','32x32','1x256','16x16','1x64','8x8','1x16','4x4']
...
save_path = 'plots/next/quant_bfp16.png'
...
X = numpy.array([4096,4096,4096,1024,1024,256,256,64,64,16,16])
print(X.shape)
fig, ax = plt.subplots()
...
ax.set_xlabel('Size')
ax.set_ylabel('MSE')
ax.set_title('BFP16 Quantization errors for different Group sizes and shapes')
