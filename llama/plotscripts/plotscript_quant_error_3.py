...
paths = ['bfp8/size_64/shape_1x64', 'bfp8/size_64/shape_8x8','bfp8/size_16/shape_1x16','bfp8/size_16/shape_4x4']
...
save_path = 'plots/next/quant_bfp8.png'
...
ax.set_xlabel('Size')
ax.set_ylabel('MSE')
ax.set_title('BFP8 Quantization errors for different Group sizes and shapes')
